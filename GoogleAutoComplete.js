...
var _reactLoadScript = __webpack_require__(344);
...
var GoogleAutoComplete = function (_React$Component) {
    _inherits(GoogleAutoComplete, _React$Component);

    function GoogleAutoComplete(props) {
        _classCallCheck(this, GoogleAutoComplete);

        var _this = _possibleConstructorReturn(this, (GoogleAutoComplete.__proto__ || Object.getPrototypeOf(GoogleAutoComplete)).call(this, props));
    ...
    _createClass(GoogleAutoComplete, [{
        ...
        value: function renderFields() {
            ...
            return Object.keys(this.props.fieldsByUser).map(function (key) {
                return _react2.default.createElement(
                    'div',
                    { className: 'address-field address-' + key },
                    _react2.default.createElement('input', { type: 'text', id: 'this', value: _this2.state.fields[key] }),
                    _react2.default.createElement(
                        'label',
                        { htmlFor: 'this' },
                        _this2.state.labels[key]
                    )
                );
            });
        }
        ...
        value: function handleSearchClear(searchText) {
        ...
        value: function handleMapChange() {
            ...
            var fields = _extends({}, this.state.fields, this.baseFields);
            if (this.place.address_components) {
                ...
                var fieldsByUser = this.props.fieldsByUser;

                Object.keys(addrComps).map(function (index) {
                    var addrType = addrComps[index].types[0];
                    switch (addrType) {
                        case fieldsByUser.locality:
                            fields.locality = addrComps[index].long_name;
                            break;

                        case fieldsByUser.cityOrState:
                            fields.cityOrState = addrComps[index].long_name;
                            break;

                        case fieldsByUser.country:
                            fields.country = addrComps[index].long_name;
                            break;

                        case fieldsByUser.postalcode:
                            fields.postalcode = addrComps[index].long_name;
                            break;

                        default:
                    }
                });
                this.setState({ fields: fields, showResult: true });
            } else {
        ...
        value: function render() {
            ...
            var _props = this.props,
                keyForAPI = _props.keyForAPI,
                id = _props.id,
                placeholder = _props.placeholder,
                label = _props.label;

            return [!scriptLoaded && _react2.default.createElement(_reactLoadScript2.default, {
                url: 'https://maps.googleapis.com/maps/api/js?key=' + keyForAPI + '&libraries=places',
                onCreate: this.handleScriptCreate.bind(this),
                onError: this.handleScriptError.bind(this),
                onLoad: this.handleScriptLoad.bind(this)
            }), _react2.default.createElement(
                'div',
                { className: 'address ' + (this.state.showResult ? "showFields" : "") },
                _react2.default.createElement(
                    'div',
                    { className: 'addressInput' },
                    _react2.default.createElement('input', { type: 'search', id: id, placeholder: placeholder, ref: function ref(ele) {
                            _this3.searchInput = ele;
                            (ele || {}).onsearch = _this3.handleSearchClear;
                        } })
                ),
                _react2.default.createElement(
                    'div',
...
GoogleAutoComplete.defaultProps = {
    ...
    callbackFunction: function callbackFunction(f) {
        return f;
    }
};
...
var _propTypes = __webpack_require__(343);
